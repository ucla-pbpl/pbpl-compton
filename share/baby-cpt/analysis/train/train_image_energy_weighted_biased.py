...
def build_model(in_x, in_y, out_x, out_y):
    model = tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(int(in_x*16*in_y), activation='relu'),
        ...
        tf.keras.layers.Dense(int(in_x*4*in_y), activation='relu'),
...
def main():
    ...
    checkpoint_path = "models-ng3p7g-1/"+name_string+".ckpt"
