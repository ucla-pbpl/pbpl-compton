...
of FACET-II gamma diagnostics',
    ...
    entry_points = {
        ...
        ['pbpl-compton-mc = pbpl.compton.mc:main',
         ...
         'pbpl-compton-sum-deposition = pbpl.compton.sum_deposition:main',
         'pbpl-compton-combine-deposition = pbpl.compton.combine_deposition:main',
         ...
         'pbpl-compton-test-plugin-mpi = pbpl.compton.test_plugin_mpi:main',
        ]
    },
    data_files=[
        ('share/lil-cpt',
